      ...
      (() => {
        ...
        $(`${this.containerSelector} #toolbar .extended-buttons button`).click(function () {
          ...
          if (id === 'save') {
            ...
            if (window.confirm('سيؤدي ذلك إلى مسح اللوحة الخلفية! هل أنت واثق؟')) {
              _self.canvas.clear(), saveInBrowser.remove('canvasEditor');
            }
          } else if (id === 'download') {
            $('body').append(`<div class="custom-modal-container">
              <div class="custom-modal-content">
                <div class="button-download" id="svg">SVG تنزيل بتنسيق</div>
                <div class="button-download" id="png">PNG تنزيل بتنسيق</div>
                <div class="button-download" id="jpg">JPGتنزيل بتنسيق</div>
              </div>
            </div>`)
