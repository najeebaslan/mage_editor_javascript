...
(function () {
  ...
  var freeDrawSettings = function () {
    ...
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="draw-panel"><div class="content"><p class="title">رسم</p></div></div>`);

    // set dimension section
    $(`${this.containerSelector} .toolpanel#draw-panel .content`).append(`
      <div>
        <div class="input-container">
          <label>عرض الفرشاة</label>
        ...
        <div class="input-container">
          ...
          <select id="input-brush-type">
            <option value="pencil" selected>قلم</option>
            <option value="circle">دائرة</option>
            <option value="spray">رش</option>
          </select>
        </div>
        <div class="input-container">
          <label>لون الفرشاة</label>
