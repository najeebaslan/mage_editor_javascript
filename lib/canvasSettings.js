...
(function () {
  ...
  var canvasSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="background-panel"><div class="content"><p class="title">إعدادات الخلفية</p></div></div>`);
    ...
    (() => {
      ...
      <div class="color-settings">
        <div class="tab-container">
          <div class="tabs">
            <div class="tab-label" data-value="color-fill">تعبئة اللون</div>
            <div class="tab-label" data-value="gradient-fill">ملئ الانحدار</div>
          </div>
            ...
            <div class="gradient-orientation-container">
              <div class="input-container">
                ...
                <select id="select-orientation">
                  ...
                  <option value="radial">شعاعي</option>
                </select>
              </div>
