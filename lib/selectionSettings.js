...
(function () {
  ...
  var selectionSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="select-panel"><div class="content"><p class="title">إعدادات التحديد</p></div></div>`);
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="text-section">
          ...
          <div class="sizes">
            <div class="input-container"><label>حجم الخط</label>
            ...
            <div class="input-container"><label>ارتفاع خط</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
            ...
            <div class="input-container"><label>تباعد الأحرف</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
          ...
          <div class="align">
            ...
            <select id="text-align">
              ...
              <option value="justify">ملأ السطر</option>
            </select>
            </div>
          </div>
          <div class="color">
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="border-section">
          <h4>الحواف</h4>
          <div class="input-container"><label>العرض</label>
            <div class="custom-number-input">
            <button class="decrease">-</button>
          ...
          <div class="input-container"><label>الظل</label><select id="input-border-style">${BorderStyleList.map(item => `<option value='${JSON.stringify(item.value)}'>${item.label}</option>`)}</select></div>
          <div class="input-container"><label>نوع الزاوية</label><select id="input-corner-type"><option value="miter" selected>مريع</option><option value="round">دائري</option></select></div>
          <div class="input-container"><label>اللون</label><input id="color-picker" value="black"></div>
          <hr>
        </div>
      `);
